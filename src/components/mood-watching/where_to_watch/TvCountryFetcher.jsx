...
import WatchTvButton from "/src/components/mood-watching/where_to_watch/WatchTvButton.jsx";
import CustomAlert from "/src/components/CustomAlert.jsx";

// eslint-disable-next-line react/prop-types
const TvCountryFetcher = ({ tv_id }) => {
  ...
  return (
    <>
      ...
      <WatchTvButton tv_id={tv_id} country_code={countryCode} />
    </>
  );
};
export default TvCountryFetcher;
